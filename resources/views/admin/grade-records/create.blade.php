...
@section('page-title', 'Registrar nota')
@section('page-subtitle', 'Formulario para agregar una calificación académica')
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h5 fw-bold mb-1">Nueva nota</h2>
            ...
            <form method="POST" action="{{ route('grade-records.store') }}">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select id="term" name="term" class="form-select rounded-pill @error('term') is-invalid @enderror" required>
                            ...
                            <option value="Primer Bimestre" @selected(old('term') === 'Primer Bimestre')>Primer Bimestre</option>
                            <option value="Segundo Bimestre" @selected(old('term') === 'Segundo Bimestre')>Segundo Bimestre</option>
                            <option value="Tercer Bimestre" @selected(old('term') === 'Tercer Bimestre')>Tercer Bimestre</option>
                            <option value="Cuarto Bimestre" @selected(old('term') === 'Cuarto Bimestre')>Cuarto Bimestre</option>
                            <option value="Final" @selected(old('term') === 'Final')>Final</option>
                        </select>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select id="evaluation_type" name="evaluation_type" class="form-select rounded-pill @error('evaluation_type') is-invalid @enderror" required>
                            <option value="Actividad" @selected(old('evaluation_type', 'Actividad') === 'Actividad')>Actividad</option>
                            <option value="Tarea" @selected(old('evaluation_type') === 'Tarea')>Tarea</option>
                            <option value="Examen corto" @selected(old('evaluation_type') === 'Examen corto')>Examen corto</option>
                            <option value="Proyecto" @selected(old('evaluation_type') === 'Proyecto')>Proyecto</option>
                            <option value="Examen final" @selected(old('evaluation_type') === 'Examen final')>Examen final</option>
                        </select>
