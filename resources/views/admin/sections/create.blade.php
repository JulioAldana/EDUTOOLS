...
@section('page-title', 'Registrar sección')
@section('page-subtitle', 'Formulario para agregar una nueva sección académica')
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h5 fw-bold mb-1">Nueva sección</h2>
                    <p class="text-muted mb-0">Complete los datos principales de la sección.</p>
                </div>
