...
@section('page-subtitle', 'Actualizar información registrada del curso académico')
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h5 fw-bold mb-1">Editar curso</h2>
                    <p class="text-muted mb-0">
                        Modifique los datos necesarios del curso.
                    </p>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        >
                            ...
                            @foreach ($grades as $grade)
                                <option value="{{ $grade->id }}" @selected(old('grade_id', $course->grade_id) == $grade->id)>
                                    {{ $grade->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input
                            ...
                            id="weekly_hours"
                            name="weekly_hours"
                            value="{{ old('weekly_hours', $course->weekly_hours) }}"
