...
@section('page-subtitle', 'Formulario para agregar un nuevo estudiante al sistema EDUTOOLS')
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h5 fw-bold mb-1">Nuevo alumno</h2>
                    <p class="text-muted mb-0">
                        Complete los datos principales del estudiante.
                    </p>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-4">
                        ...
                        <input
                            ...
                            placeholder="Ejemplo: EST-2026-001"
                            required
                        >
                        @error('student_code')
