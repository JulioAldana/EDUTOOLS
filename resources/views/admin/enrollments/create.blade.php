...
@section('page-subtitle', 'Formulario para inscribir un alumno en un ciclo académico')
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h5 fw-bold mb-1">Nueva inscripción</h2>
                    <p class="text-muted mb-0">Complete los datos de inscripción del estudiante.</p>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select id="status" name="status" class="form-select rounded-pill @error('status') is-invalid @enderror" required>
                            ...
                            <option value="retirado" @selected(old('status') === 'retirado')>Retirado</option>
